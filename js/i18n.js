const i18n = {
  ...
  translations: {
    es: {
      ...
      /* Atención detail content (placeholder) */
      'atencion.desc-sub': 'Modelo de atención conversacional híbrido (chatbot + atención humana)',
      'atencion.desc': 'Descripción general del proyecto. Incluye información sobre la empresa, el producto, y el problema de negocio que se buscaba resolver.',
      'atencion.desafio': 'Descripción del desafío específico que enfrentaban los usuarios y/o el negocio. Incluye datos sobre usuarios objetivo, sus frustraciones, y las barreras existentes.',
      'atencion.proceso': 'Descripción del proceso de diseño. Incluye las actividades de research, definición de la solución, y el proceso iterativo de diseño.',
      'atencion.resultado': 'Descripción de la solución diseñada y los resultados obtenidos. Incluye métricas de éxito y aprendizajes clave.',
    ...
    en: {
      ...
      /* Atención detail content (placeholder) */
      'atencion.desc-sub': 'Hybrid conversational care model (chatbot + human support)',
      'atencion.desc': 'General project description. Includes information about the company, the product, and the business problem to be solved.',
      'atencion.desafio': 'Description of the specific challenge users and/or the business faced. Includes data on target users, their frustrations, and existing barriers.',
      'atencion.proceso': 'Description of the design process. Includes research activities, solution definition, and the iterative design process.',
      'atencion.resultado': 'Description of the designed solution and the results obtained. Includes success metrics and key learnings.',
